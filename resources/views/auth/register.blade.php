<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <!-- Telephone -->
        <div class="mt-4">
            <x-input-label for="telephone" :value="__('Télèphone')"/>
        ...
        <!-- Image -->
        <div class="mt-4">
            <x-input-label for="imageClient" :value="__('Image de Profile')"/>
            <input id="pfp" class="block mt-1 w-full" type="file" name="pfp" accept="image/*">
